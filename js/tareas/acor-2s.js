const pages = [
  [
    { title: "Actividad 05", content: "Capturar la información detallada sobre EL PROCESADOR (CPU) del equipo utilizando el ADMINISTRADOR DE TAREAS de Windows. Posteriormente, pegar dicha información en el cuaderno. <br><br> <b>Fecha de Entrega:</b> 28-05-25"}
  ],
  [
